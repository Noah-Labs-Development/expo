 ...
 * @platform android
 */
export type RecordingSource = 'camcorder' | 'default' | 'mic' | 'remote_submix' | 'unprocessed' | 'voice_call' | 'voice_communication' | 'voice_downlink' | 'voice_performance' | 'voice_recognition' | 'voice_uplink';
